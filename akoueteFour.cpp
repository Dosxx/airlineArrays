...
87/100 Grade = B
Your program now works - very good!

See my comments below for improving
your code.

-1 VS and other compilers will not run
when a variable isn't initialized.
I had to add the following statement before the function call.
SeatSold = 0;
displaySales(SeatSold);

See my explanation in the Class Standards.
-1 And better yet, SeatSold should have been declared
in displaySales.

-1 change
const int TOTALSEAT = 36;
to
const int TOTALSEAT = ROW * COL;

-1 Don't start variable names with
an uppercase letter. See Class Standards.
int Row, indexSeat, SeatSold;
char Seat;
...
There is no need for the looping.
